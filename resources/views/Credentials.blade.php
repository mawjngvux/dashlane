...
<div class="flex flex-col items-center justify-center h-96 rounded-lg">
    ...
    <div class="flex gap-4">
        ...
        <button onclick="showAddLoginForm()" class="bg-teal-500 text-white px-4 py-2 rounded hover:bg-teal-600">
    ...
    <div class="flex flex-col h-full">
        ...
        <div class="flex-1 p-4 space-y-6 bg-gray-50">
            ...
            <div>
                ...
                <p class="text-sm text-gray-500">Preferences section (tuỳ bạn thêm hoặc bỏ)</p>
            </div>
